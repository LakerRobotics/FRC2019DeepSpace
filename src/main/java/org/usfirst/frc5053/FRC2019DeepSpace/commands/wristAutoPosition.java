 ...
 *
 */
public class wristAutoPosition extends Command {
    ...
    public wristAutoPosition(double wristPosition) {
    ...
    protected void execute() {
        Robot.wristRotation.startMoveToPosition(m_wristPosition);
    }

    // Make this return true when this Command no longer needs to run execute()
    @Override
    protected boolean isFinished() {
        return Robot.wristRotation.isTargetReached();
    }
