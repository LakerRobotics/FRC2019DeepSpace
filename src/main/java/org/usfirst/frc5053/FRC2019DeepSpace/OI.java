...
public class OI {
    ...
    public double[][] operateArmParameters =
    {
        ...
        { 820, 2549, 10.4, 10.4},       // 4: Hatch ==> Rocket High
        { 332, 1130,  0.0,  0.0},       // 14: Hatch ==> Rocket High (from back of Robot)
        {2870, 1540,  0.0,  0.0},       // 12: Cargo ==> Ground Pickup
    ...
    public OI() {
        ...
        /* PASS PROPER VARIABLES TO SETUP COMMAND
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        // COMMENT OUT THE MATCHING SECTION IN THE AUTOGENERATED CODE ABOVE
        rocketMid = new JoystickButton(logitech, 10);
        ...
        // Button on OPERATOR controller to drive the intake (NOT IN ROBOT BUILDER)
