...
public class OI {
    ...
    public double[][] operateArmParameters =
    {
        ...
        {2509, 1532, 11, 12},          // 6: Hatch ==> Rocket Low
        {2509, 1532, 13, 14},          // 7: Hatch ==> Cargo Ship
        {1632, 2321, 15, 16},          // 8: Cargo ==> Cargo Ship
        {2509, 1532, 17, 18},          // 9: Hatch ==> Feeder (Human Player)
    ...
    public OI() {
        ...
        rocketMid.whenPressed(new scoringEvent(0));
        rocketHigh = new JoystickButton(logitech, 8);
        rocketHigh.whenPressed(new scoringEvent(0));
        cargoShip = new JoystickButton(logitech, 7);
        cargoShip.whenPressed(new scoringEvent(0));
        humanPlayer = new JoystickButton(logitech, 9);
        humanPlayer.whenPressed(new scoringEvent(0));
        groundTransport = new JoystickButton(logitech, 11);
        groundTransport.whenPressed(new scoringEvent(0));
        rocketLow = new JoystickButton(logitech, 12);
        rocketLow.whenPressed(new scoringEvent(0));
        ...
        SmartDashboard.putData("scoringEvent", new scoringEvent());
