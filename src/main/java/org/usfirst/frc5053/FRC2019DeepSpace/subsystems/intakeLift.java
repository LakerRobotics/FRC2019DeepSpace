...
public class intakeLift extends Subsystem {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        /************************
     * 20190218
     * Both forward and reverse are lit at startup on the PCM
     * The thinking is that it is starting up in an arbitrary state and
     * that we should set it during initialization to prevent issues.
     ************************ */
    intakeLiftSolenoid.set(Value.kOff);
    }
