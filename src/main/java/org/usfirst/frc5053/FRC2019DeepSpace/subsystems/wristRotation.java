...
public class wristRotation extends Subsystem {
    ...
    final double WRIST_TOLERANCE = 120;
...
/**
    ...
    */
    ...
    public boolean isTargetReached(){
        double targetValue = Robot.oi.getWristTarget();
        int absolutePosition = wristTalonSRX.getSensorCollection().getPulseWidthPosition();
        double wristError = Math.abs(targetValue-absolutePosition);
        if(wristError <= WRIST_TOLERANCE) return true;
        else return false;
    }
}
